...
def sample_requests(
    ...
    for e in ds:
        ...
        prompt = tokenizer.apply_chat_template(e['prompt'], tokenize=False)
...
async def send_request(
    ...
    data = {
        ...
        'parameters': {
            ...
            'ignore_eos': True,
            'max_new_tokens': 30,
            'lr1_grammar': '/mnt/nvme0/chenjunyi/project/lightllm/lightllm/server/router/model_infer/mode_backend/continues_batch/format_out/grammar/json_grammar.ebnf',
            #'temperature': 0.1,
        }
    }
...
def main(args: argparse.Namespace):
    ...
    input_requests = sample_requests(args.num_prompts, tokenizer)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Benchmark the JSON-Mode-Eval.")
...
""" Execute command:
python benchmark_json_mode_eval.py --tokenizer /mnt/nvme0/models/Meta-Llama-3.1-8B-Instruct/ \
    --num-prompts 1
"""
